...
<body>
        ...
        <form action="" method="post" name="form1">
          <table width="900" border="0">
            ...
            <tr>
              ...
              <td><input type="submit" name="cadastra" id="button" class="input" value="Cadastrar"></td>
            </tr>
          </table>
        </form>
        <br>
        ...
        if (mysqli_num_rows($result) <= 0)
          ...
          <table width="900" border="0">
            ...
            <tr>
              ...
              <td><h3>
                <?php $sql_2 = "SELECT * FROM disciplinas WHERE curso = '$curso'";
  ...
  <?php if (@$_GET['pg'] == 'disciplina') { ?>
    <div id="box_disciplinas">
      ...
      <?php if (@$_GET['cadastra'] == 'sim') { ?>
        <br><br>
        <h1>Cadastra nova disciplina</h1>
        <?php
        ...
        <form action="" method="post" name="form1">
          <table width="900" border="0">
            ...
            <tr>
              ...
              <td><input type="text" name="disciplina" id="textfield"></td>
              <td width="143">
      ...
      <?php
        if (@$_GET['deleta'] == 'sim') {
          $id = $_GET['id'];
          $sql_3 = "DELETE FROM disciplinas WHERE id = '$id'";
          mysqli_query($conexao, $sql_3);
