          ...
          <form name="form1" action="" method="post" enctype="multipart/form-data">
            <table width="900" border="0">
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="salario" id="textfield8" value="<?php echo $res_1['salario']; ?>">
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>
                  <input type="text" name="pos_graduacao" id="textfield6" value="<?php echo $res_1['pos_graduacao']; ?>">
                </td>
                <td>
                  <input type="text" name="mestrado" id="textfield7" value="<?php echo $res_1['mestrado']; ?>">
                </td>
                <td>
                  <input type="text" name="doutorado" id="textfield9" value="<?php echo $res_1['doutorado']; ?>">
                </td>
              </tr>
              <tr>
    ...
    <div id="cadastra_professores">
      ...
      <?php
        if (isset($_POST['button'])) {
          ...
          $graduacao = $_POST['graduacao'];
          $pos_graduacao = $_POST['pos_graduacao'];
          $mestrado = $_POST['mestrado$mestrado'];
          $doutorado = $_POST['doutorado'];
          $salario = $_POST['salario'];
      ...
      <form name="form1" action="" method="post">
        <table width="900" border="0">
          ...
          <tr>
            ...
            <td><input type="text" name="cpf" id="textfield3"></td>
          </tr>
          <tr>
            <td>Data de nascimento:</td>
            <td>Formação Acadêmica:</td>
